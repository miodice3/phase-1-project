class Scraper
    ...
    def first_scrape
       ...
       short=trails_parsed_to_html.css('#trail')        #make request to HTML webpage. short are the bundle of all trails
        ...
        short.each_with_index do |each_trail, index|                                  #iterate over each of the all trails bundle
            ...
            second_scrape = ""
            #uniq_id = index
            trail_class_create_hash = {trail_name_key: trail_name, state_instance: state_instance, length_mi_key: length_mi, trail_desc_short_key: trail_desc_short, trail_url_key: trail_url, second_scrape_key: second_scrape, unique_id_key: index}
